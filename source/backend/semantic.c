...
// static void analysis_local_declared(const DeerAST *local_declared, int *var_idx, symbol_space **space)
// {
...
// static void analysis_func_declared(const DeerAST *func_declared, symbol_table **table)
// {
...
//     // local_decl 
//     analysis_local_declared(func_declared->sub_list[3], &var_idx, &space);
...
int semantic_analysis(DeerCompilerHandle *handle)
{
    ...
    //         analysis_func_declared(declared, &handle->table);
    //     } else {
    //         global_space = get_global_space(handle->table);
    //         analysis_local_declared(declared, &global_idx, &global_space);
    //     }
    // }
